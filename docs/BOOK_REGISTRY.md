...
| `mmsell`, `mmsell1`, `mmsell2`, `mmsell3` | **paper** (`mmsell3` LIVE closed 2026-07-19, see below) | `docs/RESEARCH_JOURNAL.md`, `docs/edge_research.md`, `docs/MMSELL_LIVE_PLAN.md`, `docs/MMSELL_LIVE_POSTMORTEM.md` | favorite-longshot maker-sell in the cheap band (mostly sports) | `mmsell3` passed its paper gate, went LIVE 2026-07-13, **CLOSED LIVE 2026-07-19** (n=296, 89.9% win, −1.23¢/trade, ≈−$3.64 total; loss engine outlived World Cup, reattaching to MLB/tennis/cricket h2h-winners) — see `docs/MMSELL_LIVE_POSTMORTEM.md`. Paper `mmsell3` + variants continue; re-live-test candidate once a variant clears its gate |

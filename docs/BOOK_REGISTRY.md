...
| `mmsell`, `mmsell1`, `mmsell2`, `mmsell3` | **paper** (`mmsell3` LIVE path built, inert) | `docs/RESEARCH_JOURNAL.md`, `docs/edge_research.md`, `docs/MMSELL_LIVE_PLAN.md` | favorite-longshot maker-sell in the cheap band (mostly sports) | `mmsell3` passed its paper gate (n≥150, per-trade >+1.5¢, ≥ mmsell1/mmsell2). LIVE test built 2026-07-13 (maker NO-buy, inert until `LIVE_STRATEGIES=mmsell3`); Stage-1 gate: at **n≥150 filled**, fill-rate ≥50% AND live-win ≥90% to scale — see `docs/MMSELL_LIVE_PLAN.md` §6 |

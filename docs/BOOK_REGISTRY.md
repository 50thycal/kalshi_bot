...
| `mmsell`, `mmsell1`, `mmsell2`, `mmsell3` | **paper** (`mmsell3` LIVE closed 2026-07-19, see below) | `docs/RESEARCH_JOURNAL.md`, `docs/edge_research.md`, `docs/MMSELL_LIVE_PLAN.md`, `docs/MMSELL_LIVE_POSTMORTEM.md` | favorite-longshot maker-sell in the cheap band (mostly sports) | `mmsell3` passed its paper gate, went LIVE 2026-07-13, **CLOSED LIVE 2026-07-19** (final n=359, 91.1% win, +0.18¢/trade realized ≈ breakeven; loss engine outlived World Cup, reattaching to MLB/tennis/cricket h2h-winners) — see `docs/MMSELL_LIVE_POSTMORTEM.md`. **Divergence root-caused (`docs/MMSELL_FILL_MODEL.md`): maker adverse selection — paper counts the +3.77¢ winners a resting order can't fill.** Under the fill model paper `mmsell3` reads −1.06¢ realizable (MIRAGE), matching the live loss. Paper `mmsell3` + variants continue; re-live-test only from the cheap fillable band (mmsell10 regime) |

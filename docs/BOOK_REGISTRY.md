...
| `mmsell`, `mmsell1`, `mmsell2`, `mmsell3` | **paper** | `docs/RESEARCH_JOURNAL.md`, `docs/edge_research.md` | favorite-longshot maker-sell in the cheap band (mostly sports) | `mmsell3` (5–10¢ band): at **n≥150**, KEEP only if per-trade **> +1.5¢** AND ≥ mmsell1/mmsell2 |

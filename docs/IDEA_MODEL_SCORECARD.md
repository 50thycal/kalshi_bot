...
|---|---|---|---|---|---|---|
| 2026-09-12 | **EARNBEAT** | directional on a public base rate (company KPIs) | **broad sweep** (`docs/IDEA_MODEL_20260912.md`, anti-anchor slot) | — | **pending census** (HOLD-by-venue-age) | `scripts/kalshi_kpi_census.py` built; TESTABLE-NOW iff ≥100 settled KPI threshold markets w/ volume and ≥60 readable pre-report quotes, else HOLD with re-run week of 2026-11-09. `docs/EARNBEAT_THESIS.md`. |
| 2026-09-12 | **METALHALT** | obs-pin / mechanics-blindness (exchange-closure pin, metals) | **broad sweep** (riff on FREEZE on the settlement-source axis WS-005 asked for) | — | **pending census** | `scripts/kalshi_metalhalt_census.py` built; PROMOTE-TO-PROBE iff ≥40 settled Pyth-halt windows w/ volume and post-halt trading at ≥3¢; HOLD (universe absent) otherwise — either outcome closes WS-005 D1. `docs/METALHALT_THESIS.md`. |

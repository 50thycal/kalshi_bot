...
2026-09-12 broad sweep added three (PERPMM, METALHALT, EARNBEAT), all census-first and pending. The
...
| 2026-09-12 | **PERPMM** | maker / liquidity provision (perp premium reversion, both legs passive) | **broad sweep** (riff on PERP-V1: the one thread its close-out left open) | — | **pending census** | `scripts/perp_candle_census.py` built; PROMOTE-TO-PROBE iff perp candles carry high/low and BTC+ETH active-minute share ≥50%; BLOCKED_DATA if closes only. `docs/PERPMM_THESIS.md`. |

...
(2026-09-12), one perp microstructure census, pending probe; 0 promotions to a trading book.
...
|---|---|---|---|---|---|---|
| 2026-09-12 | **PASSIVE-PERP** | perp microstructure / reversion | Calvin selected BTC/ETH passive execution; probe-first approval | — | **pending census** | Fixed retained-tape price-return screen, not premium P&L or a fill simulation. No XOS promotion; `docs/PASSIVE_PERP_CENSUS.md`. |

...
|---|---|---|---|---|---|
| [WS-021](WS-021-autonomous-desks.md) | Autonomous ChatGPT and Claude desks | REVIEW | Active | Review external session worker and read-only launch checks; deployment remains pending | [#443](https://github.com/50thycal/kalshi_bot/pull/443) |

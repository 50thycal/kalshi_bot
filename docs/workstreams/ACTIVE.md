...
|---|---|---|---|---|---|
| [WS-021](WS-021-autonomous-desks.md) | Autonomous ChatGPT and Claude desks | REVIEW | Active | Review primary-account scoping (DEC-020); verify worker deployment and remaining launch access | [#449](https://github.com/50thycal/kalshi_bot/pull/449), [#448](https://github.com/50thycal/kalshi_bot/pull/448) |

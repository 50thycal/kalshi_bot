...
|---|---|---|---|---|---|
| [WS-021](WS-021-autonomous-desks.md) | Autonomous ChatGPT and Claude desks | REVIEW | Active | Merge execution-cutover proof; finish canonical impact accounting and [worker protection acceptance](../desks/WORKER_PROTECTION.md) | [#449](https://github.com/50thycal/kalshi_bot/pull/449), [#448](https://github.com/50thycal/kalshi_bot/pull/448) |

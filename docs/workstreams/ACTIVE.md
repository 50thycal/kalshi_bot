...
|---|---|---|---|---|---|
| [WS-021](WS-021-autonomous-desks.md) | Autonomous ChatGPT and Claude desks | REVIEW | Active | Owner review after green CI; live launch requires external isolation/runtime readiness | [#443](https://github.com/50thycal/kalshi_bot/pull/443) |

...
| [WS-008](WS-008-epoch-deployment-continuity.md) | An epoch boundary must not silently stop the books (XOS-000011) | REVIEW | Active | Merge, then run `REPAIR_LINEAGE` for `tmmsell-epoch-repair` and confirm the mmsell family is recording again | this PR |

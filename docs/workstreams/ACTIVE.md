...
| [WS-010](WS-010-perp-v1-pre-registration.md) | PERP-V1: a research surface for Kalshi perpetual futures | BUILDING | Active | Operator act: submit `REGISTER_PACKAGE` for `perp-v1` (it redeploys the worker while the mmsell10 canary holds real money). The blocking research question is answered — A4 resolved, D4 closed, nothing in the contract needs changing before it freezes | [#275](https://github.com/50thycal/kalshi_bot/pull/275), [#277](https://github.com/50thycal/kalshi_bot/pull/277), this PR |

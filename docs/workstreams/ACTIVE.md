...
| [WS-011](WS-011-marktangle-conditional-reversion.md) | MARKTANGLE: conditional reversion in recurring binary families | BUILDING | Active | Merge, register the package on the experiment-command transport, then run the Phase-A probe and record its verdict | [#276](https://github.com/50thycal/kalshi_bot/pull/276) |

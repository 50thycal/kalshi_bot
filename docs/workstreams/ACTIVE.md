...
| [WS-010](WS-010-marktangle-conditional-reversion.md) | MARKTANGLE: conditional reversion in recurring binary families | BUILDING | Active | Merge, register the package on the experiment-command transport, then run the Phase-A probe and record its verdict | this PR |

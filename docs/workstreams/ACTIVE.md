...
|---|---|---|---|---|---|
| [WS-020](WS-020-liquidity-incentive-shadow.md) | Liquidity-incentive shadow market maker — Phase 0 instrumentation, no orders | REVIEW | Active — **RUNNING** | Shadow enabled on the evo service 2026-09-17 12:24Z; collector healthy, 3,939 programs discovered. Operator: day-one check 3 (compare one market's displayed projected reward against our estimate) before any `est_` reward figure is believed; then accumulate to the 14-day window | [#415](https://github.com/50thycal/kalshi_bot/pull/415), [#416](https://github.com/50thycal/kalshi_bot/pull/416) merged |

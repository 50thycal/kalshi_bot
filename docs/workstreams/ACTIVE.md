...
|---|---|---|---|---|---|
| [WS-021](WS-021-autonomous-desks.md) | Autonomous ChatGPT and Claude desks | REVIEW | Active | Review app-session mode (DEC-019); provision private app/exchange access and alerts before common start | [#445](https://github.com/50thycal/kalshi_bot/pull/445) |

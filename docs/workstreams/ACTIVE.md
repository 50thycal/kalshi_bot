...
| [WS-010](WS-010-perp-v1-pre-registration.md) | PERP-V1: a research surface for Kalshi perpetual futures | BUILDING | Active | Re-run the Probe 0 surface survey and read whether funding is reachable anywhere (A4). That answer settles D4, and D4 should be settled before `REGISTER_PACKAGE` freezes the contract | [#275](https://github.com/50thycal/kalshi_bot/pull/275), [#277](https://github.com/50thycal/kalshi_bot/pull/277) |

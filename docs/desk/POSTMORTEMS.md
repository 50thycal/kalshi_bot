...
|---|---|---|---|
| `D-2026-09-19-NP1` | 2026-09-20 | `process` | **The desk's uncertainty band was wider than its own measurements justified, and the no-pick cost a 35-point edge.** On Sat 20:31Z the week-to-date was 108.99T with 27.5h left and three measured paces of 0.711, 0.841 and 0.711 T/h. The desk wrote the band as 0.65–0.84 T/h, projecting **126.9–132.1T**, called that "straddling three strikes", and passed. Using the pace range it had actually measured, 0.711–0.841, the projection was **128.5–132.1T** — entirely above the 128 strike, which was then offered at **58¢**. The week is now tracking to ~129.4T and that strike bid **93¢**. The error was not the reasoning, it was inventing a 0.65 lower bound no observation supported. A band must be built from the measurements, and a band widened "to be safe" is a claim about the data like any other. Mirror image of `D-2026-09-19-001`, which was over-confident: this one was under-confident, and both are calibration failures. |

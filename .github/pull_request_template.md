<!-- Build OS v0.4 Implementation Handoff. Canonical framework: 50thycal/build-os,
     ...
     PROJECT-SPECIFIC (kalshi_bot):
     - Experiment OS stays canonical for experiments, Versions, epochs, deployments, arms,
       gates, platform revisions, impact actions and XOS issues. LINK to them; do not
       restate a standing, a gate verdict or a P&L number here (DEC-001).
     - If the change touches shared semantics (fees, fills, taxonomy, execution, risk,
